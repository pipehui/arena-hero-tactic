...
_CRITICAL_REJECTION_METADATA = frozenset(
    {
        ...
        "core_retreat_first_step",
        "core_retreat_route_mode",
        "core_retreat_target",
        "dead_end_rejected",
        "first_step_heat",
        "enemy_distance_after",
        "enemy_distance_before",
        "escape_filter_rejections",
        "escape_loop_period",
        "escape_route_version",
        "escape_waypoint",
        "escape_waypoint_lease",
        "escape_waypoint_assigned_tick",
        "escape_waypoint_expires_tick",
        "escape_waypoint_distance",
        ...
        "terminal_exception",
        "visible_candidates",
        "visible_enemy_distance_after",
        "visible_enemy_distance_before",
